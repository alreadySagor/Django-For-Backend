...
def add_category(request):
    if request.method == 'POST': # user post request koreche
        ...
        if category_form.is_valid(): # post kora data gula valid kina seta check korlam/kortechi
            category_form.save() # jodi data valid hoy tahole data gula databse e save korbo.
