...
class TransactionForm(forms.ModelForm):
    ...
    def save(self, commit = True):
        ...
        self.instance.balance_after_transaction = self.account.balance # suppouse 0(main balance)--> 5000(deposite) = 5000(total_balance/balance_after_transaction)
        return super().save()
    

class DepositeForm(TransactionForm):
    def clean_amount(self): # amount field ke filter korbo | clean_amount --> builtin ekta function (clean_... jei field ta niye kaj korte chai sei field ta use korbo, jenehtu amount niye kaj kortechi tai amount niyechi)
